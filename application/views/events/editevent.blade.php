...
<form action="{{ $links.update_event }}" method="POST" enctype="multipart/form-data">
...
<div class="row-fluid">
  ...
  <a class="span3 input left">
    <input type="text" name="title" class="" value="{{ $event->title }}" placeholder="Title..." />
  </a>
...
<div class="row-fluid">
  ...
  <a class="span8 input left">
    <textarea name="description" rows="3" class="input-description" placeholder="Event description...">{{ $event->description }}</textarea>
  </a>
...
<div class="row-fluid">
  ...
  <a class="span3 input left">
    ...
    <input type="text" name="date" value="{{ $event->date }}" placeholder="YYYY/MM/DD" />
  </a>
...
<div class="row-fluid">
  ...
  <a class="span3 input left">
    <input type="text" name="video_url" value="{{ $event->video_url }}" placeholder="Video url..." />
  </a>
  ...
  <a class="span3 input left">
    <input type="text" name="facebook_url" value="{{ $event->facebook_url }}" placeholder="Facebook url..." />
  </a>
</div>
...
<div class="row-fluid">
  ...
  <a class="span3 input left">
    <input type="text" name="customizable_left_title" value="{{ $event->customizable_right_title }}" placeholder="Left content title..." />
  </a>
  ...
  <a class="span3 input left">
    <input type="text" name="customizable_right_title" value="{{ $event->customizable_left_title }}" placeholder="Right content title..." />
  </a>
</div>
...
<div class="row-fluid">
  ...
  <a class="span3 input left">
    <textarea type="text" name="customizable_left_content" class="textarea" placeholder="Left customizable content...">{{ $event->customizable_left_content }}</textarea>
  </a>
  ...
  <a class="span3 input left">
    <textarea type="text" name="customizable_right_content" class="textarea" placeholder="Right customizable content..." >{{ $event->customizable_right_content }}</textarea>
  </a>
</div>
