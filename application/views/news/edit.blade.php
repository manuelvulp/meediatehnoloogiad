...
<form action="{{ $links.edit_news }}{{ $entry->news_id }}" method="POST" enctype="multipart/form-data">
<input type="hidden" name="id" value="{{ $entry->news_id }}" />
...
<div class="row-fluid">
  ...
  <a class="span3 input left">
    <input type="text" name="news_title" class="" value="{{ $entry->title }}" placeholder="News title..." />
  </a>
...
<div class="row-fluid">
  ...
  <a class="span8 input left">
    <textarea name="news_content" rows="3" class="input-description" placeholder="News content...">{{ $entry->content }}</textarea>
  </a>
...
<div class="row-fluid">
  ...
  <a class="span3 text-event left">
    <input type="submit" class="btn" value="Change entry" />
  </a>
